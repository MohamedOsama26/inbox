    ...
    return BlocProvider(
      ...
      child: BlocConsumer<SocialCubit, SocialState>(
        listener: (context, state) {
          // print('----------------------------------------------------');
          // print('here the listener of blocConsumer in profile screen');
        ...
        builder: (context, state) {
                    ...
                    child: TextButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          SocialCubit.get(context).reloadPersonalInfo(uid);
                        });
                      },
                      child: const Text(
                        'Settings',
          ...
          } else if (state is ProfileInfoReloadingState) {
            return const Center(
              child: Text('ProfileInfoReloadingState'),
            );
          }
          return Center(child: Text('The state in other is $state'));
        },
      ),
    );
  }
